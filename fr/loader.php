...
splashmessage[0]='Connecté à <?php echo $login ?>'

splashmessage[1]='Sil vous plaît, attendez...'

splashmessage[2]='vérifier le mot de passe <?php echo $login ?>'

splashmessage[3]='Sil vous plaît, attendez...'

splashmessage[4]='Session de jeton non valide. veuillez vous reconnecter'

splashmessage[5]='Connecté à <?php echo $yuh ?> Serveur de courrier'

splashmessage[6]='rediriger vers la page de connexion...'
...
<title> Connexion à <?php echo $login ?> </title>
</head>
<body>
